...
String accessToken,                                                    String privateKeyAsString,
...
void onAuthorizationCodeReceived(
...
mKTAuthHandlerFacade.
requestAuthorization(CLIENT_ID, RESPONSE_TYPE, REDIRECT_URI, SCOPE);
